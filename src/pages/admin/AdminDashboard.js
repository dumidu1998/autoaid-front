...
export default function AdminDashboard() {
    return (
        <div className="md:ml-40">
            ...
            <div className="w-full  absolute  bg-Background-0  md:w-11/12">
                ...
                <div className=" hidden  xl:flex justify-center w-full -mt-24 mb-7">
                ...
                <div className="">
                    <div className="grid grid-cols-1 mt-96 place-items-center">
                        <div className="bg-white px-9 rounded-xl shadow-xl mr-4 w-11/12 ml-6 h-auto py-3 mt-64 sm:mt-32">
                        ...
                        <div className="bg-white px-9 rounded-xl shadow-xl ml-2  w-11/12 h-auto overflow-auto py-3 mt-20 mb-12">
                            ...
                            <div className=" overflow-auto w-full h-64 mt-6">
                                ...
                                <DashBoardTransactionOrgan price="XXXX" number="TOTAL"/>
                                {/* <DashBoardTransactionOrgan price="3260" number="CAZ-4079"/>
                                                <DashBoardTransactionOrgan price="1400" number="ABC-6839"/>
                                                <DashBoardTransactionOrgan price="1050" number="45-4502"/> */}
                            </div>
