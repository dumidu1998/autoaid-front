...
export default function BottomNav() {
    return (
        <div>
            <div className=" flex items-center justify-center w-full rounded-t-3xl shadow-xl blur-lg h-16 bottom-0 backdrop-filter backdrop-blur-lg fixed bg-gradient-to-br from-white to-transparent">
