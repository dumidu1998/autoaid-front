            ...
            <div className="md:flex flex-col items-center bg-forth-0 py-5 rounded-lg mb-5 shadow-xl hidden relative">
                ...
                <div className="w-10/12 flex items-start justify-between">
                    <div className="flex flex-col items-center">
                        ...
                        {props.data.queued.length == 0 ? <div className="w-1/3 flex  my-1 items-center justify-center" ><p className="font-primary text-white text-xs my-1 ml-2 text-center">All are Forwarded to Services</p></div> : props.data.queued.map((it, index) => (
                        <div className="flex my-1 items-center justify-center" key={index}>
                            ...
                            <p className="font-primary text-white text-xs my-1 ml-2 text-center">{it}</p>
                        </div>
                    ))}
                    ...
                    <div>
                        ...
                        {props.data.ongoing.length == 0 ? <div className=" flex  my-1 items-center justify-center" ><p className="font-primary text-white text-xs my-1  text-center">Not yet started</p></div> : props.data.ongoing.map((it, index) => (
                        <div className=" flex my-1 items-center justify-center" key={index}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6  text-primary-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                        ...
                        {props.data.completed.length == 0 ? <div className=" flex my-1 items-center justify-center" ><p className="font-primary text-white text-xs my-1  text-center">Nothing Done yet</p></div> : props.data.completed.map((it, index) => (
                        <div className=" flex  my-1 items-center justify-center" key={index}>
