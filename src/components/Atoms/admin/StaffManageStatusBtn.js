...
function StaffManageStatusBtn(props) {
    ...
    return (
        <div>
            <button onClick={clickBtn} className="rounded-xl w-32 h-12 bg-gradient-to-r from-primary-0 to-Secondary-0 font-bold text-white text-xl">{props.status}</button>
        </div>
    );
